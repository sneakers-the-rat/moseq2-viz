...
data/test_data.avi:
	aws s3 cp s3://moseq2-app-test-data/moseq2-viz/ data/ --request-payer=requester --recursive

data/test_index.yaml:
	aws s3 cp s3://moseq2-app-test-data/moseq2-pca data/ --request-payer=requester --recursive

data/test_scores.h5:
	aws s3 cp s3://moseq2-app-test-data/moseq2-viz/ data/_pca/ --request-payer=requester --recursive
